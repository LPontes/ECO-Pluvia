...
class ECOPluvia:
    ...
    def rodarHidroWeb(self,valores): #chama a claase Hidroweb atribuindo as variaveis obtidas anteriormente
    ...
    def executar(self):
        ...
        for est in self.estacoes:
            try:
                ...
                print '** %s ** - ERRO: Estacao nao possui dados ou falha na conexão.\n' % (est, )
